<h2><a href="https://leetcode.com/problems/minimum-time-to-revert-word-to-initial-state-i/?envType=problem-list-v2&envId=string">3297. Minimum Time to Revert Word to Initial State I</a></h2><h3>Medium</h3><hr><p>You are given a <strong>0-indexed</strong> string <code>word</code> and an integer <code>k</code>.</p>
